...
public class StorageSlot : Slot
{
    ...
    protected override IEnumerator Start()
    {
        ...
        bagRect = Inventory.Instance.Storage.gameObject.transform as RectTransform;
    }
    #endregion
    ...
    public override void OnBeginDrag(PointerEventData eventData)
    {
        ...
        storagePage.SlotActive(Row, Col, Item, true);
    ...
    public override void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (Item != null)
        {
            ...
            storagePage.SlotActive(Row, Col, Item, false);
        }
        else
        {
            storagePage.Items.Remove(this);
        }
